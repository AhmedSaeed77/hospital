...
@endphp
@section('title', __('dashboard.qualifications'))
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('dashboard.university')</th>
                                    <th>@lang('dashboard.college')</th>
                                    <th>@lang('dashboard.degree')</th>
                                    <th>@lang('dashboard.Operations')</th>
                                </tr>
                                </thead>
                                <tbody>
                                @forelse($doctors_qualifications as $doctors_qualification)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $doctors_qualification->t('university') }}</td>
                                        <td>{{ $doctors_qualification->t('college') }}</td>
                                        <td>{{ $doctors_qualification->t('degree') }}</td>
                                      <td>
                                            <div class="operations-btns" style="">
                                                <a href="{{ route('qualifications.edit', [$doctor_id,$doctors_qualification->id]) }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content float-left">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('qualifications.destroy', [$doctor_id,$doctors_qualification->id]) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        {{ method_field('delete') }}
                                                                        <button type="submit"
