...
@section('title', __('dashboard.Create') . ' ' . __('dashboard.genders'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('genders.store') }}" method="post" autocomplete="off"
                              enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create') @lang('dashboard.genders')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
