    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('experiences.store',$doctor_id) }}" method="post" autocomplete="off"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="hospital_ar" type="text" class="form-control"
                                                   ...
                                                   value="{{ old('hospital_ar') }}" placeholder="@lang('dashboard.hospital_ar')" >
                                        </div>
                                    </div>
                                    @error('hospital_ar')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="hospital_en" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('hospital_en') }}" placeholder="@lang('dashboard.hospital_en')" >
                                        </div>
                                    </div>
                                    @error('hospital_ar')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="job_title_ar" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('job_title_ar') }}" placeholder="@lang('dashboard.job_title_ar')">
                                        </div>
                                    </div>
                                    @error('job_title_ar')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="job_title_en" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('job_title_en') }}" placeholder="@lang('dashboard.job_title_en')" >
                                        </div>
                                    </div>
                                    @error('job_title_en')
                                    <div class="text-danger">{{ $message }}</div>
