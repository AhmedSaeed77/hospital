                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="address_ar" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('address_ar') }}" placeholder="@lang('dashboard.Address Ar')">
                                        </div>
                                    </div>
                                    @error('address_ar')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="address_en" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('address_en') }}" placeholder="@lang('dashboard.Address En')" >
                                        </div>
                                    </div>
                                    @error('address_en')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="lat" type="number" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('lat') }}" placeholder="@lang('dashboard.lat')">
                                        </div>
                                    </div>
                                    @error('lat')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="lng" type="number" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('lng') }}" placeholder="@lang('dashboard.lng')" >
                                        </div>
                                    </div>
                                    @error('lng')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="price_per_hour" type="number" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('price_per_hour') }}" placeholder="@lang('dashboard.price_per_hour')">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="patient_number" type="number" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('patient_number') }}" placeholder="@lang('dashboard.patient_number')" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="experience_years" type="number" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ old('experience_years') }}" placeholder="@lang('dashboard.experience_years')">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="city_id"  class="form-control" >
                                                ...
                                                @foreach($cities as $city)
                                                    <option value="{{ $city->id }}">{{ $city->t('name') }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="gender_id"  class="form-control" >
                                                ...
                                                @foreach($genders as $gender)
                                                    <option value="{{ $gender->id }}">{{ $gender->t('name') }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="bio_ar"  class="form-control" id="exampleInputName1" placeholder="@lang('dashboard.bio_ar')"></textarea>
                                        </div>
                                    </div>
                                    @error('bio_ar')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="bio_en"  class="form-control" id="exampleInputName1" placeholder="@lang('dashboard.bio_en')"></textarea>
                                        </div>
                                    </div>
                                    @error('bio_en')
                                    <div class="text-danger">{{ $message }}</div>
