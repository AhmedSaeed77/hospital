                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ar[about][title]" type="text" class="form-control"
                                                id="exampleInputName1" value="{{ $content['ar']['about']['title'] ?? '' }}"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="en[about][title]" type="text" class="form-control"
                                                id="exampleInputEmail1" value="{{ $content['en']['about']['title'] ?? '' }}"
                                                placeholder="" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea required name="ar[about][description]"
                                                class="form-control summernote" id="exampleInputMainTitle2" placeholder="">{!! $content['ar']['about']['description'] ?? '' !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="exampleInputContent1">@lang('dashboard.description')  @lang('dashboard.en')</label>
                                                <textarea required name="en[about][description]"
                                                class="form-control summernote" id="exampleInputMainTitle2" placeholder="">{!! $content['en']['about']['description'] ?? '' !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- Hero Section -->
